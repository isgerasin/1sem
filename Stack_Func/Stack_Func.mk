...
##
## Debug
ProjectName            :=Stack_Func
ConfigurationName      :=Debug
WorkspacePath          := "/media/ilya/48AC7766EB621CC7/Programms_Codelite/Industrial Programming"
ProjectPath            := "/media/ilya/48AC7766EB621CC7/Programms_Codelite/Industrial Programming/Stack_Func"
...
ObjectsFileList        :="Stack_Func.txt"
PCHCompileFlags        :=
...
Objects0=$(IntermediateDirectory)/Stack.cpp$(ObjectSuffix) 
...
$(IntermediateDirectory)/Stack.cpp$(ObjectSuffix): Stack.cpp $(IntermediateDirectory)/Stack.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/media/ilya/48AC7766EB621CC7/Programms_Codelite/Industrial Programming/Stack_Func/Stack.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Stack.cpp$(ObjectSuffix) $(IncludePath)
